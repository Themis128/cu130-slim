...
- Name: calendar.test.ts >> Calendar Page — real backend >> should switch to week view
- Location: tests/calendar.test.ts:141:3

# Error details

```
Error: Real login failed for e2e-39167@social-auto.test: 429 {"error":"Rate limit exceeded: 10 per 1 minute"}
```
