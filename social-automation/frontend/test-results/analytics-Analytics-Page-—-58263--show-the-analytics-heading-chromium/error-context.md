...
- Name: analytics.test.ts >> Analytics Page — real backend >> should load and show the analytics heading
- Location: tests/analytics.test.ts:12:3

# Error details

```
Error: Real login failed for e2e-37435@social-auto.test: 401 {"detail":"Invalid credentials"}
```
