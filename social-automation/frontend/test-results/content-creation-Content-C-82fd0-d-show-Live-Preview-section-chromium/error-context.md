...
- Name: content-creation.test.ts >> Content Creation Page — real backend >> should show Live Preview section
- Location: tests/content-creation.test.ts:90:3

# Error details

```
Error: Real login failed for e2e-40043@social-auto.test: 429 {"error":"Rate limit exceeded: 10 per 1 minute"}
```
