...
- Name: content-creation.test.ts >> Content Creation Page — real backend >> should display the Platforms section
- Location: tests/content-creation.test.ts:35:3

# Error details

```
Error: Real login failed for e2e-39477@social-auto.test: 429 {"error":"Rate limit exceeded: 10 per 1 minute"}
```
