...
- Name: analytics.test.ts >> Analytics Page — real backend >> should display the time range selector
- Location: tests/analytics.test.ts:45:3

# Error details

```
Error: Real login failed for e2e-37689@social-auto.test: 401 {"detail":"Invalid credentials"}
```
