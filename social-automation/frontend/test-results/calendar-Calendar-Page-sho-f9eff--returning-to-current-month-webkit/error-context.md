...
- generic [ref=f1e1]:
  - generic [ref=f1e4]:
    ...
    - generic [ref=f1e9]:
      ...
      - generic [ref=f1e13]:
        - generic [ref=f1e14]:
          ...
          - link "Forgot password?" [ref=f1e16]:
            - /url: /forgot-password
    ...
    - paragraph [ref=f1e21]:
      ...
      - link "Sign up" [ref=f1e22]:
        - /url: /register
  - button "Open Tanstack query devtools" [ref=f1e93] [cursor=pointer]
  - generic [active]:
    - menu "Next.js Dev Tools Items" [ref=f1e162]:
      - generic [ref=f1e163]:
        - menuitem "Route Static" [ref=f1e164] [cursor=pointer]:
          - generic [ref=f1e165]: Route
          - generic [ref=f1e166]: Static
        - generic "Turbopack is enabled." [ref=f1e167]:
          - generic [ref=f1e168]: Bundler
          - generic [ref=f1e169]: Turbopack
        - menuitem "Route Info" [ref=f1e170]
      - menuitem "Preferences" [ref=f1e176]
    - button "Close Next.js Dev Tools" [expanded] [ref=f1e186] [cursor=pointer]
  - alert [ref=f1e192]
```
