...
- Name: content-creation.test.ts >> Content Creation Page — real backend >> should show preview placeholder when no platform is selected
- Location: tests/content-creation.test.ts:95:3

# Error details

```
Error: Real login failed for e2e-40120@social-auto.test: 429 {"error":"Rate limit exceeded: 10 per 1 minute"}
```
