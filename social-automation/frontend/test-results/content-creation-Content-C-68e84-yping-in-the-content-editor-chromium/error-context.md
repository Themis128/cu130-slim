...
- Name: content-creation.test.ts >> Content Creation Page — real backend >> should allow typing in the content editor
- Location: tests/content-creation.test.ts:51:3

# Error details

```
Error: Real login failed for e2e-39617@social-auto.test: 429 {"error":"Rate limit exceeded: 10 per 1 minute"}
```
