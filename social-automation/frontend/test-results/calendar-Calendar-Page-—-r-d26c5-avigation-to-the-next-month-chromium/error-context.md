...
- Name: calendar.test.ts >> Calendar Page — real backend >> should allow navigation to the next month
- Location: tests/calendar.test.ts:81:3

# Error details

```
Error: Real login failed for e2e-38680@social-auto.test: 429 {"error":"Rate limit exceeded: 10 per 1 minute"}
```
