...
- Name: analytics.test.ts >> Analytics Page — real backend >> should display all 5 KPI cards with zero values for a fresh user
- Location: tests/analytics.test.ts:19:3

# Error details

```
Error: Real login failed for e2e-37429@social-auto.test: 401 {"detail":"Invalid credentials"}
```
