...
- Name: calendar.test.ts >> Calendar Page — real backend >> should load and show the current month
- Location: tests/calendar.test.ts:13:3

# Error details

```
Error: Real login failed for e2e-38105@social-auto.test: 429 {"error":"Rate limit exceeded: 10 per 1 minute"}
```
