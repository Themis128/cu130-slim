...
- Name: analytics.test.ts >> Analytics Page — real backend >> should display the platform filter
- Location: tests/analytics.test.ts:51:3

# Error details

```
Error: Real login failed for e2e-37733@social-auto.test: 401 {"detail":"Invalid credentials"}
```
