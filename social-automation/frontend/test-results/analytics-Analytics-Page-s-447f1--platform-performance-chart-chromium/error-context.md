...
- Name: analytics.test.ts >> Analytics Page >> should display platform performance chart
- Location: tests/analytics.test.ts:185:3
...
Locator: getByRole('heading', { name: 'Platform Performance' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Platform Performance' })
