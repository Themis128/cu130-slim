...
- Name: analytics.test.ts >> Analytics Page — real backend >> should display the sync button
- Location: tests/analytics.test.ts:61:3

# Error details

```
Error: Real login failed for e2e-37884@social-auto.test: 401 {"detail":"Invalid credentials"}
```
