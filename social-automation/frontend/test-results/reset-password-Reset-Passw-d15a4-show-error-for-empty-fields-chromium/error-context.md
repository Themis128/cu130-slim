...
- Name: reset-password.test.ts >> Reset Password Page — real backend >> should show error for empty fields
- Location: tests/reset-password.test.ts:27:3
...
Call log:
  - waiting for getByRole('button', { name: /reset password/i })
