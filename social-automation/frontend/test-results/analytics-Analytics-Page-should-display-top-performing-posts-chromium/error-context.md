...
- Name: analytics.test.ts >> Analytics Page >> should display top performing posts
- Location: tests/analytics.test.ts:227:3
...
Locator: getByRole('heading', { name: 'Top Performing Posts' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Top Performing Posts' })
