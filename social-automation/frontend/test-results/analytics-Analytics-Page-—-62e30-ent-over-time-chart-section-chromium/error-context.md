...
- Name: analytics.test.ts >> Analytics Page — real backend >> should display the engagement over time chart section
- Location: tests/analytics.test.ts:33:3

# Error details

```
Error: Real login failed for e2e-37578@social-auto.test: 401 {"detail":"Invalid credentials"}
```
