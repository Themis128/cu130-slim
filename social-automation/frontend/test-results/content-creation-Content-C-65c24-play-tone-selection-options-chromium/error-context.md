...
- Name: content-creation.test.ts >> Content Creation Page — real backend >> should display tone selection options
- Location: tests/content-creation.test.ts:59:3

# Error details

```
Error: Real login failed for e2e-39692@social-auto.test: 429 {"error":"Rate limit exceeded: 10 per 1 minute"}
```
