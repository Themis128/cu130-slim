...
- Name: analytics.test.ts >> Analytics Page >> should display platform breakdown table
- Location: tests/analytics.test.ts:206:3
...
Locator: getByRole('heading', { name: 'Platform Breakdown' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Platform Breakdown' })
