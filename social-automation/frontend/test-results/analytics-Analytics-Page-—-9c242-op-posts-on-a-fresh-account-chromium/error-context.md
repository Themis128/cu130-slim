...
- Name: analytics.test.ts >> Analytics Page — real backend >> should show empty state for top posts on a fresh account
- Location: tests/analytics.test.ts:66:3

# Error details

```
Error: Real login failed for e2e-38019@social-auto.test: 401 {"detail":"Invalid credentials"}
```
