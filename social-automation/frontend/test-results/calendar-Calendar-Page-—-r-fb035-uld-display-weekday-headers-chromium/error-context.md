...
- Name: calendar.test.ts >> Calendar Page — real backend >> should display weekday headers
- Location: tests/calendar.test.ts:25:3

# Error details

```
Error: Real login failed for e2e-38166@social-auto.test: 429 {"error":"Rate limit exceeded: 10 per 1 minute"}
```
