...
- Name: analytics.test.ts >> Analytics Page >> should display engagement over time chart
- Location: tests/analytics.test.ts:173:3
...
Locator: getByRole('heading', { name: 'Engagement Over Time' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Engagement Over Time' })
