...
- Name: analytics.test.ts >> Analytics Page — real backend >> should display the platform metrics section
- Location: tests/analytics.test.ts:39:3

# Error details

```
Error: Real login failed for e2e-37586@social-auto.test: 401 {"detail":"Invalid credentials"}
```
