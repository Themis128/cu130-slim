...
- Name: content-creation.test.ts >> Content Creation Page — real backend >> should show all 6 platform buttons (disabled for a fresh user)
- Location: tests/content-creation.test.ts:40:3

# Error details

```
Error: Real login failed for e2e-39551@social-auto.test: 429 {"error":"Rate limit exceeded: 10 per 1 minute"}
```
