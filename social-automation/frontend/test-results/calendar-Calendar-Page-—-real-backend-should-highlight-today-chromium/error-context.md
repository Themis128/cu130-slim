...
- Name: calendar.test.ts >> Calendar Page — real backend >> should highlight today
- Location: tests/calendar.test.ts:42:3

# Error details

```
Error: Real login failed for e2e-38317@social-auto.test: 429 {"error":"Rate limit exceeded: 10 per 1 minute"}
```
