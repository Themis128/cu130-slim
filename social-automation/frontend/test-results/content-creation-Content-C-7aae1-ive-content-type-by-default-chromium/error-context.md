...
- Name: content-creation.test.ts >> Content Creation Page — real backend >> should show Post as the active content type by default
- Location: tests/content-creation.test.ts:29:3

# Error details

```
Error: Real login failed for e2e-39412@social-auto.test: 429 {"error":"Rate limit exceeded: 10 per 1 minute"}
```
