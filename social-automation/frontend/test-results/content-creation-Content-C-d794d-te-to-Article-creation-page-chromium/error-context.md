...
- Name: content-creation.test.ts >> Content Creation Page — real backend >> should navigate to Article creation page
- Location: tests/content-creation.test.ts:117:3

# Error details

```
Error: Real login failed for e2e-40416@social-auto.test: 429 {"error":"Rate limit exceeded: 10 per 1 minute"}
```
