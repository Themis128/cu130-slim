...
- Name: calendar.test.ts >> Calendar Page — real backend >> should navigate to content creation when clicking New Post
- Location: tests/calendar.test.ts:62:3

# Error details

```
Error: Real login failed for e2e-38541@social-auto.test: 429 {"error":"Rate limit exceeded: 10 per 1 minute"}
```
