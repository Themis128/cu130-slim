...
- Name: calendar.test.ts >> Calendar Page — real backend >> should allow navigation to the previous month
- Location: tests/calendar.test.ts:68:3

# Error details

```
Error: Real login failed for e2e-38596@social-auto.test: 429 {"error":"Rate limit exceeded: 10 per 1 minute"}
```
