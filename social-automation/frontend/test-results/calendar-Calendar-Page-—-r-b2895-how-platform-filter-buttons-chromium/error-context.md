...
- Name: calendar.test.ts >> Calendar Page — real backend >> should show platform filter buttons
- Location: tests/calendar.test.ts:128:3

# Error details

```
Error: Real login failed for e2e-39019@social-auto.test: 429 {"error":"Rate limit exceeded: 10 per 1 minute"}
```
