...
- Name: calendar.test.ts >> Calendar Page — real backend >> should display the calendar grid with day cells
- Location: tests/calendar.test.ts:32:3

# Error details

```
Error: Real login failed for e2e-38253@social-auto.test: 429 {"error":"Rate limit exceeded: 10 per 1 minute"}
```
