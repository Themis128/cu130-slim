...
- Name: analytics.test.ts >> Analytics Page >> should display impressions by platform chart
- Location: tests/analytics.test.ts:198:3
...
Locator: getByRole('heading', { name: 'Impressions by Platform' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Impressions by Platform' })
