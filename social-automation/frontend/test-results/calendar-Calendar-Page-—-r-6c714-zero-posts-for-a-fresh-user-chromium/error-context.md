...
- Name: calendar.test.ts >> Calendar Page — real backend >> should show zero posts for a fresh user
- Location: tests/calendar.test.ts:50:3

# Error details

```
Error: Real login failed for e2e-38413@social-auto.test: 429 {"error":"Rate limit exceeded: 10 per 1 minute"}
```
