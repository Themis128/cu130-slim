...
- Name: forgot-password.test.ts >> Forgot Password Page >> should show error for empty email
  ...
  - generic [ref=e4]:
    ...
    - generic [ref=e9]:
      - generic [ref=e10]:
        - text: Email
        - generic [ref=e15]:
          - textbox "Email" [invalid] [ref=e16]:
            - /placeholder: you@example.com
          - alert [ref=e17]: Email is required
      - button "Send reset link" [active] [ref=e18] [cursor=pointer]
    - paragraph [ref=e20]:
