...
- Name: analytics.test.ts >> Analytics Page — real backend >> should show loading skeleton initially
- Location: tests/analytics.test.ts:72:3

# Error details

```
Error: Real login failed for e2e-38027@social-auto.test: 401 {"detail":"Invalid credentials"}
```
