...
- Name: analytics.test.ts >> Analytics Page >> should display key metrics cards
- Location: tests/analytics.test.ts:108:3
...
Locator: getByText('Connected Accounts')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Connected Accounts')
