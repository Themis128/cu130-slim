...
- Name: analytics.test.ts >> Analytics Page — real backend >> should display the compare toggle button
- Location: tests/analytics.test.ts:56:3

# Error details

```
Error: Real login failed for e2e-37876@social-auto.test: 401 {"detail":"Invalid credentials"}
```
