"""Pytest config shared across unit and integration suites.

Some modules initialize Settings at import-time; provide safe test defaults for
required env vars so tests can run without a developer `.env`.
"""
