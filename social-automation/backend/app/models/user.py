...
class AuditLog(Base):
    """Audit log — records who did what, when, and from where."""
    ...
    action: Mapped[str] = mapped_column(String(50), nullable=False)  # create, update, delete, publish, approve, etc.
    resource_type: Mapped[str] = mapped_column(String(50), nullable=False)  # post, account, pillar, template, etc.
