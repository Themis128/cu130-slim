...
ENV_DEFINITIONS = {
    ...
    "INSTAGRAM_USERNAME": {"category": "Social Media", "description": "Instagram private API username", "required": False, "sensitive": True},
    "INSTAGRAM_PASSWORD": {"category": "Social Media", "description": "Instagram private API password", "required": False, "sensitive": True},
    ...
    "FACEBOOK_USERNAME": {"category": "Social Media", "description": "Facebook browser-automation username", "required": False, "sensitive": True},
    "FACEBOOK_PASSWORD": {"category": "Social Media", "description": "Facebook browser-automation password", "required": False, "sensitive": True},
    ...
    "LINKEDIN_USERNAME": {"category": "Social Media", "description": "LinkedIn browser-automation username", "required": False, "sensitive": True},
    "LINKEDIN_PASSWORD": {"category": "Social Media", "description": "LinkedIn browser-automation password", "required": False, "sensitive": True},
    "TIKTOK_PRIVATE_API_KEY": {"category": "Social Media", "description": "TikTok private API signing key", "required": False, "sensitive": True},
    # AI Services
